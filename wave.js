...
function prompt(slot, b) {
  return [
    ...
    '',
    'חובה: קרא את data/no-reply.json לפני שאתה כותב משהו. מי שמופיע שם לא מקבל',
    'תשובה בשום מקרה, גם אם התגובה שלו נחמדה ומתאימה לתרחיש. ההתאמה חלקית ולא',
    'תלוית אותיות, על שם המשתמש ועל שם התצוגה. לייק מותר אלא אם כתוב likes:false.',
    'לא מוחקים, לא חוסמים ולא מגיבים בחזרה. אם נתקלת באחד מהם ויש לו מזהה מדויק',
    'שעוד לא רשום, הוסף אותו ל-handles שלו באותו קובץ ודווח על זה.',
    '',
