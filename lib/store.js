...
// Which monitor this is. Defaults to Itzik's data folder, so a copy with no
// instance.json behaves exactly as it did before there was one.
const inst = require('./instance.js');
const DATA_DIR = inst.dataPath;
